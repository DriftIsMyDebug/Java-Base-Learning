...
// выводом информации о самом крупном городе мира использовались статические переменные класса вместо локальных аргументов метода.
...
public class Task0613 {
    public static final String CITY = "Токио";
    public static double POPULATION_IN_TOKYO = 34.5;
    ...
    public static void printCityPopulation(String city, double population) {
        ...
        System.out.println("В то время как в самом густонаселенном городе " + Task0613.CITY + " население составляет " + Task0613.POPULATION_IN_TOKYO + " млн человек.");
    }
}
