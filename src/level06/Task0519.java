...
public class Task0519 {
    ...
    public static void main(String[] args) {
        int[] sortedArray = Arrays.copyOf(array, array.length); // копирование данных из массива
        Arrays.sort(sortedArray); // сортировка массива по возрастанию
        int index = Arrays.binarySearch(sortedArray, element); // нахождение индекса искомого элемента в бинарном поиске
